...
describe('Service Tests', () => {
  describe('Salle routing resolve service', () => {
    ...
    let resultSalle: ISalle | undefined;
    ...
    describe('resolve', () => {
      ...
      it('should return new ISalle if id is not provided', () => {
        // GIVEN
        ...
        expect(resultSalle).toEqual(new Salle());
      });

      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Salle })));
        mockActivatedRouteSnapshot.params = { id: 123 };
